...
data = datapreprocess.data_preperation("Wage") # load dataset
...
plt.tight_layout()
plt.savefig(f"StableTrees_examples\plots\\example_mse_simulated_overtime_UAI__wage_with_BABU.png")
plt.close()
...
adjust_text(texts,add_objects=scatters,ax= ax)
plt.tight_layout()
plt.savefig(f"StableTrees_examples\plots\\example_mse_simulated_overtime_UAI_wage.png")
plt.close()
