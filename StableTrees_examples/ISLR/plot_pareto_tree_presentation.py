...
fig, axes = plt.subplots(nrows=1, ncols=3, figsize=(11,5),dpi=500)#
axes = axes.ravel()
...
fig.tight_layout()
#plt.show()
plt.savefig(f"StableTrees_examples\plots\\real_data_mse_pareto_{method}_presentation.png")
plt.close()